...
function ProductForm({ categories, product, close }: { categories: CategoryOption[]; product: ProductRow | null; close: () => void }) {
  ...
  const inputClass = "mt-1.5 w-full rounded-lg border border-gray-300 bg-white px-3 py-2.5 outline-none focus:border-[#073b78]";

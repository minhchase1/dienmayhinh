...
import { bankTransferConfig } from "@/lib/payments";
...
export default async function Checkout() {
  ...
  return <CheckoutForm user={user ? { name: user.name, email: user.email } : null} addresses={addresses satisfies SavedAddress[]} bankTransferAvailable={Boolean(bankTransferConfig())}/>;
}
